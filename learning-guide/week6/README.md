...
| Day 2 | [Q、K、V 逐项拆解](./02-Day2-QKV逐项拆解-三个变换三种角色.md) | 三个变换三种角色；公式三步：点积 → softmax → 加权求和 |
...
- 对 Attention 公式里每个符号（Q、K、V、QK^T、softmax、sqrt(d)、加权求和）**透彻、可脱稿讲解**的理解——这是学 LLM 底层绕不开的第一道坎，你跨过去了。
