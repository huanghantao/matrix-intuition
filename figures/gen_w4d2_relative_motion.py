...
point(ax1, (1, 1), color=C_BLUE, label="(1,1)")
point(ax1, (2, 3), color=C_RED, label="(2,3)")
...
ax2.text(1, -0.4, "新刻度“2”", color="#888888", ha="center", fontsize=11)
ax2.scatter([0], [1], color="#888888", s=40, zorder=6)
ax2.text(-0.32, 1, "新刻度“3”", color="#888888", va="center", fontsize=11)
ax2.text(2.9, 1.6, "新尺子读数 = (2,3)\n（x 单位缩到 1/2，y 缩到 1/3）",
